...
class GaussianPredictor(nn.Module):
    def __init__(self, cfg):
        ...
        elif cfg.model.name == "depth_anything_v2":
            from models.encoder.depth_anything_encoder import DepthAnythingV2Extended
            models["depth_anything_extended"] = DepthAnythingV2Extended(cfg)
            self.parameters_to_train += models["depth_anything_extended"].get_parameter_groups()
    ...
    def forward(self, inputs):
        ...
        if cfg.model.name == "unidepth":
            ...
            outputs = self.models["depth_anything_extended"](inputs)
