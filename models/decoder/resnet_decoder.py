...
class ResnetDepthDecoder(nn.Module):
    ...
    def __init__(self, cfg, num_ch_enc, use_skips=True):
        ...
        # Both UniDepth and Depth Anything provide the first/base depth layer;
        # this decoder only predicts positive offsets for the remaining layers.
        has_external_base_depth = cfg.model.name in {"unidepth", "depth_anything_v2"}
        self.num_output_channels = cfg.model.gaussians_per_pixel - 1 if has_external_base_depth else cfg.model.gaussians_per_pixel
